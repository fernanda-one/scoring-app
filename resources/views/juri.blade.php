...
<body>
    ...
    <div id="first-line-point-group" class="flex lg:justify-between gap-2 lg:gap-0 mt-[0%] lg:mt-[5%]">
        <div class="w-full flex justify-between lg:justify-normal">
            <div id="round-1-blueInput-div"  class="bg-blueDefault py-3 w-[83%] lg:w-[70%] rounded-r-[20px] pl-6 shadow-inset-custom">
        ...
        <div class="w-full flex justify-end">
            ...
            <div id="round-1-redInput-div" class="bg-redDefault py-3 w-[83%] lg:w-[70%] rounded-l-[20px] pr-6 shadow-inset-custom">
    ...
    <div class="flex justify-between mt-0 lg:mt-[5%] ml-0 mr-0 lg:ml-[2%] lg:mr-[2%]">
        ...
        <div class="flex flex-row lg:flex-col justify-start w-[50%]">
            <div class="flex items-center">
                <button id="pukul-biru" type="button" class="bg-blueDefault shadow-inset-custom hover:bg-blueDark disabled:cursor-not-allowed rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 transform transition-transform ease-in-out duration-100 active:scale-95">
            ...
            <div class="flex items-center mt-0 lg:mt-[3%]">
                <button id="tendang-biru" type="button" class="bg-blueDefault shadow-inset-custom hover:bg-blueDark disabled:cursor-not-allowed rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2 transform transition-transform ease-in-out duration-100 active:scale-95">
