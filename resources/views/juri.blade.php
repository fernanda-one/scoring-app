        ...
        <div class="flex justify-between">
            ...
            <div>
                ...
                <div class="flex mx-auto justify-center w-[100px] 2xl:w-[200px] xl:w-[185px] lg:w-[140px] md:w-[105px] bg-grayDark py-2 rounded-b-[90px]">
                    <p id="round" class="font-bold text-whiteDefault text-base">ROUND 1</p>
                </div>
            </div>
            <div>
    ...
    <div class="flex justify-between mt-[5%] ml-[2%] mr-[2%]">
        ...
        <div class="flex flex-col justify-start w-[50%]">
            <div class="flex items-center">
                <button id="pukul-merah" type="button" class="bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                ...
                <div class="flex flex-col items-center ml-24">
                    ...
                    <div class="flex justify-center mt-[8%]">
                        <div id="juri-pertama-pukulan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                        <div id="juri-kedua-pukulan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] mx-[24px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                        <div id="juri-ketiga-pukulan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center mt-[3%]">
                <button id="tendang-merah" type="button" class="bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                ...
                <div class="flex flex-col items-center ml-24">
                    ...
                    <div class="flex justify-center mt-[8%]">
                        <div id="juri-pertama-tendangan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                        <div id="juri-kedua-tendangan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] mx-[24px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                        <div id="juri-ketiga-tendangan-red" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-col justify-start items-end w-[50%]">
            <div class="flex items-center">
                <div class="flex flex-col items-center mr-24">
                    ...
                    <div class="flex justify-center mt-[8%]">
                        <div id="juri-pertama-pukulan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                        <div id="juri-kedua-pukulan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] mx-[24px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                        <div id="juri-ketiga-pukulan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">1</p>
                        </div>
                    </div>
                </div>
                <button id="pukul-biru" type="button" class="bg-blueDefault hover:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <div class="flex items-center mt-[3%]">
                <div class="flex flex-col items-center mr-24">
                    ...
                    <div class="flex justify-center mt-[8%]">
                        <div id="juri-pertama-tendangan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                        <div id="juri-kedua-tendangan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] mx-[24px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                        <div id="juri-ketiga-tendangan-blue" class="flex items-center justify-center bg-grayDefault w-[68px] h-[45px] rounded-[10px]">
                            <p class="text-whiteDefault">2</p>
                        </div>
                    </div>
                </div>
                <button id="tendang-biru" type="button" class="bg-blueDefault hover:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[24px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="92" height="90" viewBox="0 0 92 90" fill="none">
