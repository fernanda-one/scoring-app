        ...
        <div class="flex h-[450px] w-[50%]">
            ...
            <div class="flex flex-col justify-start w-[60%] lg:w-[55%] h-screen lg:h-[70%] mx-[3.5%]">
                <div class="flex justify-between w-[100%]">
                    <div id="teguran-merah-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                    ...
                    <div id="binaan-merah-pertama"  class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                ...
                <div class="flex justify-between w-[100%]">
                    <div  id="teguran-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 45 47" fill="none">
                    ...
                    <div id="binaan-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
        ...
        <div class="flex h-[450px] w-[50%]">
            <div class="flex flex-col justify-start w-[60%] lg:w-[55%] h-screen lg:h-[70%] mx-[3.5%]">
                <div class="flex justify-between w-[100%]">
                    ...
                    <div id="binaan-biru-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 68 67" fill="none">
                            <path d="M46.75 33.5003L52.428 40.9596C53.2213 42.0017 53.6199 43.2843 53.5547 44.5853C53.4895 45.8864 52.9646 47.124 52.071 48.084L41.3497 59.608C40.2787 60.7609 38.7657 61.417 37.1762 61.417H24.0833C17.2833 61.417 12.75 55.8336 12.75 50.2503V26.3229C12.75 19.9412 21.25 19.9412 21.25 26.3229V27.917" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M21.25 27.9168V23.1319C21.25 16.7502 29.75 16.7502 29.75 23.1319V27.9168V20.9377C29.75 14.5559 38.25 14.5559 38.25 20.9377V27.9168V9.7682C38.2508 8.65809 38.6989 7.5937 39.4958 6.809C40.2927 6.02429 41.3733 5.5835 42.5 5.5835C43.6272 5.5835 44.7082 6.02468 45.5052 6.80999C46.3022 7.5953 46.75 8.6604 46.75 9.771V41.8752" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div id="teguran-biru-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                ...
                <div class="flex justify-between w-[100%]">
                    ...
                    <div id="binaan-biru-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 68 67" fill="none">
                    ...
                    <div id="teguran-biru-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 67 67" fill="none">
