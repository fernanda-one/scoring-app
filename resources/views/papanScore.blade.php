...
<body class="font-poppins">
    ...
    <div class="flex justify-between mt-[1%] overflow-hidden">
        <div class="flex h-[450px] w-[50%]">
            <div class="flex items-center justify-center w-[40%] lg:w-[45%] h-screen lg:h-[70%] rounded-r-[30px] bg-blueDefault">
            ...
            <div class="flex flex-col justify-start w-[60%] lg:w-[55%] h-screen lg:h-[70%] mx-[3.5%]">
                <div class="flex justify-between w-[100%]">
                    <div id="binaan-biru-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                    ...
                    <div id="teguran-biru-pertama"  class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                    ...
                    <div id="peringatan-biru-pertama" class="flex justify-center items-center w-[50%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
                            <path d="M14.708 21.8679L10.7835 26.7735C10.2352 27.4588 9.95971 28.3023 10.0048 29.1579C10.0498 30.0136 10.4126 30.8275 11.0303 31.4588L18.4406 39.0376C19.1808 39.7958 20.2266 40.2273 21.3252 40.2273H30.3747C35.0747 40.2273 38.208 36.5554 38.208 32.8835L38.208 17.1477C38.208 12.9508 32.333 12.9508 32.333 17.1477L32.333 18.196" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M32.333 18.1562L32.333 15.0095C32.333 10.8125 26.458 10.8125 26.458 15.0095L26.458 18.1562L26.458 13.5664C26.458 9.36945 20.583 9.36945 20.583 13.5664L20.583 18.1562L20.583 6.22082C20.5825 5.49076 20.2728 4.79076 19.7219 4.2747C19.1711 3.75864 18.4242 3.46875 17.6455 3.46875C16.8664 3.46875 16.1193 3.75889 15.5684 4.27535C15.0175 4.79181 14.708 5.49227 14.708 6.22266L14.708 27.3359" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                ...
                <div class="flex justify-between w-[100%]">
                    <div  id="binaan-biru-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 45 47" fill="none">
                    ...
                    <div id="teguran-biru-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
                    ...
                    <div id="peringatan-biru-kedua" class="flex justify-center items-center w-[50%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
                ...
                <div class="flex justify-end w-[100%]">
                    <div id="peringatan-biru-ketiga" class="flex justify-center items-center w-[45%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                ...
                <div class="flex justify-between items-end h-full w-[100%] px-6 gap-6">
                    <div class="w-[30%]">
                        ...
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-pertama-pukulan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-pertama-tendangan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                    ...
                    <div class="w-[30%]">
                        ...
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-kedua-pukulan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-kedua-tendangan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">2</p>
                            </div>
                        </div>
                    </div>
                    <div class="w-[30%]">
                        ...
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-ketiga-pukulan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-ketiga-tendangan-blue" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">2</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex h-[450px] w-[50%]">
            <div class="flex flex-col justify-start w-[60%] lg:w-[55%] h-screen lg:h-[70%] mx-[3.5%]">
                <div class="flex justify-between w-[100%]">
                    <div id="peringatan-merah-pertama" class="flex justify-center items-center w-[50%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                    ...
                    <div id="teguran-merah-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 68 67" fill="none">
                            <path d="M46.75 33.5003L52.428 40.9596C53.2213 42.0017 53.6199 43.2843 53.5547 44.5853C53.4895 45.8864 52.9646 47.124 52.071 48.084L41.3497 59.608C40.2787 60.7609 38.7657 61.417 37.1762 61.417H24.0833C17.2833 61.417 12.75 55.8336 12.75 50.2503V26.3229C12.75 19.9412 21.25 19.9412 21.25 26.3229V27.917" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M21.25 27.9168V23.1319C21.25 16.7502 29.75 16.7502 29.75 23.1319V27.9168V20.9377C29.75 14.5559 38.25 14.5559 38.25 20.9377V27.9168V9.7682C38.2508 8.65809 38.6989 7.5937 39.4958 6.809C40.2927 6.02429 41.3733 5.5835 42.5 5.5835C43.6272 5.5835 44.7082 6.02468 45.5052 6.80999C46.3022 7.5953 46.75 8.6604 46.75 9.771V41.8752" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div id="binaan-merah-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                ...
                <div class="flex justify-between w-[100%]">
                    <div id="peringatan-merah-kedua" class="flex justify-center items-center w-[50%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 68 67" fill="none">
                    ...
                    <div id="teguran-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mx-4 mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 68 67" fill="none">
                    ...
                    <div id="binaan-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 67 67" fill="none">
                ...
                <div class="flex justify-between w-[100%]">
                    <div id="peringatan-merah-ketiga" class="flex justify-center items-center w-[45%] bg-grayDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mb-4 shadow-inset-custom">
                ...
                <div class="flex justify-between items-end h-full w-[100%] px-6 gap-5">
                    <div class="w-[30%]">
                        <p class="flex justify-center font-poppins-bold text-xl text-darkGray">JURI 1</p>
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-pertama-pukulan-red" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-pertama-tendangan-red" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">2</p>
                            </div>
                        </div>
                    </div>
                    <div class="w-[30%]">
                        <p class="flex justify-center font-poppins-bold text-xl text-darkGray">JURI 2</p>
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-kedua-pukulan-red" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-kedua-tendangan-red" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">2</p>
                            </div>
                        </div>
                    </div>
                    <div class="w-[30%]">
                        <p class="flex justify-center font-poppins-bold text-xl text-darkGray">JURI 3</p>
                        <div class="flex justify-center mt-[20%] 2xl:mt-[10%] gap-2">
                            <div id="juri-ketiga-pukulan-red" class="flex items-center justify-center bg-grayDefault py-2 px-5 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">1</p>
                            </div>
                            <div id="juri-ketiga-tendangan-red" class="flex items-center justify-center bg-grayDefault py-2 px-4 rounded-[8px] shadow-inset-custom">
                                <p class="text-whiteDefault font-semibold text-2xl">2</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex items-center justify-center w-[40%] lg:w-[45%] h-screen lg:h-[70%] rounded-l-[30px] bg-redDefault">
