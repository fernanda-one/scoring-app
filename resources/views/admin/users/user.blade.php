...
@section('container')
    <div class="flex-row justify-center items-center mt-20">
...
{{--                        </td>--}}
{{--                        <td class="px-6 py-4">--}}
{{--                            <a href="/admin/users/{{ $user->id }}/edit" class="font-medium text-green-600 dark:text-green-500 hover:underline">Edit</a>--}}
{{--                            <form action="/admin/users/{{ $user->id }}" class="inline" method="post">--}}
{{--                                @method('delete')--}}
{{--                                @csrf--}}
