...
@section('container')
    <div
        class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-8 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div>
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <td class="w-4 p-4">
                                            <div class="flex items-center">
                                                <input id="checkbox-{{ $user['id'] }}" aria-describedby="checkbox-1"
                                                    type="checkbox"
                                                    class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" />
                                                <label for="checkbox-{{ $user['id'] }}" class="sr-only">
                                                    checkbox
                                                </label>
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center">
                                                <div
                                                    class="h-2.5 w-2.5 rounded-full {{ $user['active'] ? 'bg-green-400 mr-4' : 'bg-red-500 mr-2' }}">
                                                </div>
                                                <div class=" flex items-center">
                                                    {{ $user['active'] ? 'active' : 'non-active' }}</div>
                                            </div>
                                        </td>
