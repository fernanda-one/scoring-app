                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="post">
                        ...
                        @if(session('error'))
                            <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                ...
                                <div>
                                    <span class="font-medium">Oops!</span> Username atau password salah!
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm font-medium text-blueDefault hover:underline">Forgot password?</a>
                        </div>
                        <button type="submit" class="w-full text-white bg-blueDefault hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
                    </form>
                </div>
            </div>
        </div>
