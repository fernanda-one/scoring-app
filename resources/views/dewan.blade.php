...
<div class="flex justify-between mt-[3%] ml-[1%] mr-[2%]">
    ...
    <div class="flex flex-col justify-start w-[50%]">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="teguran-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault hover:bg-redDefault focus:bg-redDefault focus:ring-2 focus:outline-none focus:ring-redDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 45 47" fill="none">
            ...
            <button type="button" id="binaan-merah-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault hover:bg-redDefault focus:bg-redDefault focus:ring-2 focus:outline-none focus:ring-redDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="peringatan-merah-kedua" class="flex justify-center items-center w-[50%] bg-grayDefault hover:bg-redDefault focus:bg-redDefault focus:ring-2 focus:outline-none focus:ring-redDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="jatuhan-merah-plus" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDefault focus:bg-redDefault focus:ring-2 focus:outline-none focus:ring-redDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="popup-merah" class="flex justify-center items-center w-[100%] bg-redDefault hover:bg-redDefault focus:bg-redDefault focus:ring-2 focus:outline-none focus:ring-redDefault rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
    ...
    <div class="flex flex-col justify-start items-end w-[50%]">
        <div class="flex justify-between w-[70%]">
            ...
            <button type="button" id="binaan-biru-pertama" class="flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            ...
            <button type="button" id="binaan-biru-kedua" class="flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" class="flex justify-center items-center w-[100%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DISK</p>
            </button>
        </div>
        <div class="flex justify-between w-[70%]">
            <button type="button" id="popup-biru" class="flex justify-center items-center w-[100%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">Pop Up</p>
            </button>
        </div>
    </div>
