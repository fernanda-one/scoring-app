...
<div class="flex justify-between">
    <div class="w-full flex mt-[5%]">
        <div id="round-1-blueInput-div"  class="bg-blueDefault py-3 w-[70%] rounded-r-[20px] pl-6 shadow-inset-custom">
            <p id="round-1-blueInput" class="text-whiteDefault"></p>
        </div>
        <div id="round-1-blueScore-div"  class="flex items-center justify-center w-[54px] h-[54px] bg-blueDefault rounded-full ml-[2%] shadow-inset-custom">
            <p id="round-1-blueScore" class="text-whiteDefault">0</p>
        </div>
    </div>
    <div class="w-full flex mt-[5%] justify-end">
        <div id="round-1-redScore-div" class="flex items-center justify-center w-[54px] h-[54px] bg-redDefault rounded-full mr-[2%] shadow-inset-custom">
...
<div class="flex justify-between">
    <div class="w-full flex mt-[2%]">
        ...
        <div id="round-2-blueScore-div"  class="flex items-center justify-center w-[54px] h-[54px] bg-grayDefault rounded-full ml-[2%]">
            <p id="round-2-blueScore" class="text-whiteDefault"></p>
            <p id="round-2-blueScore" class="text-whiteDefault"></p>
        </div>
    </div>
    <div class="w-full flex mt-[2%] justify-end">
        <div id="round-2-redScore-div" class="flex items-center justify-center w-[54px] h-[54px] bg-grayDefault rounded-full mr-[2%]">
...
<div class="flex justify-between">
    <div class="w-full flex mt-[2%]">
        ...
        <div id="round-3-blueScore-div"  class="flex items-center justify-center w-[54px] h-[54px] bg-grayDefault rounded-full ml-[2%]">
            <p id="round-3-blueScore" class="text-whiteDefault"></p>
        </div>
    </div>
    <div class="w-full flex mt-[2%] justify-end">
        <div id="round-3-redScore-div" class="flex items-center justify-center w-[54px] h-[54px] bg-grayDefault rounded-full mr-[2%]">
...
<div class="flex justify-between mt-[3%] ml-[1%] mr-[2%]">
    ...
    <div class="flex flex-col justify-start w-[50%]">
        <div class="flex justify-between w-[70%]">
            <button type="button" id="binaan-biru-pertama" class="shadow-inset-custom focus-red-button flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="teguran-biru-pertama" class="shadow-inset-custom focus-red-button flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="peringatan-biru-pertama" class="shadow-inset-custom focus-red-button flex justify-center items-center w-[50%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
                    <path d="M14.708 21.8679L10.7835 26.7735C10.2352 27.4588 9.95971 28.3023 10.0048 29.1579C10.0498 30.0136 10.4126 30.8275 11.0303 31.4588L18.4406 39.0376C19.1808 39.7958 20.2266 40.2273 21.3252 40.2273H30.3747C35.0747 40.2273 38.208 36.5554 38.208 32.8835L38.208 17.1477C38.208 12.9508 32.333 12.9508 32.333 17.1477L32.333 18.196" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M32.333 18.1562L32.333 15.0095C32.333 10.8125 26.458 10.8125 26.458 15.0095L26.458 18.1562L26.458 13.5664C26.458 9.36945 20.583 9.36945 20.583 13.5664L20.583 18.1562L20.583 6.22082C20.5825 5.49076 20.2728 4.79076 19.7219 4.2747C19.1711 3.75864 18.4242 3.46875 17.6455 3.46875C16.8664 3.46875 16.1193 3.75889 15.5684 4.27535C15.0175 4.79181 14.708 5.49227 14.708 6.22266L14.708 27.3359" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="binaan-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 45 47" fill="none">
            ...
            <button type="button" id="teguran-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="peringatan-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            ...
            <button type="button" id="peringatan-biru-ketiga" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault disabled:cursor-not-allowed  rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="disk-biru" class="shadow-inset-custom focus-red-button flex justify-center items-center w-[100%] bg-blueDefault  rounded-[14px] text-sm px-5 disabled:cursor-not-allowed  py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DISKULIFIKASI</p>
            </button>
        </div>
        <div class="flex justify-between w-[70%]">
            <button type="button" id="popup-biru" class="shadow-inset-custom flex justify-center items-center w-[100%] bg-blueDefault hover:bg-blueDefault  rounded-[14px] text-sm px-5 py-2.5 disabled:cursor-not-allowed  text-center inline-flex items-center mr-2 mb-2">
    ...
    <div class="flex flex-col justify-start items-end w-[50%]">
        <div class="flex justify-between w-[70%]">
            <button type="button" id="peringatan-merah-pertama" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="teguran-merah-pertama" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="binaan-merah-pertama" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="peringatan-merah-kedua" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
            ...
            <button type="button" id="teguran-merah-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
            ...
            <button type="button" id="binaan-merah-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="47" viewBox="0 0 43 47" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            <button id="disk-merah"  type="button" class="shadow-inset-custom flex justify-center items-center w-[100%] bg-redDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DISKULIFIKASI</p>
            </button>
        </div>
        <div class="flex justify-between w-[70%]">
            <button  type="button" id="popup-merah" class="shadow-inset-custom flex justify-center items-center w-[100%] bg-redDefault disabled:cursor-not-allowed rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">MULAI PENGAMBILAN KEPUTUSAN</p>
            </button>
        </div>
    </div>
