...
<div class="flex justify-between mt-[3%] ml-[1%] mr-[2%]">
    ...
    <div class="flex flex-col justify-start items-end w-[50%]">
        <div class="flex justify-between w-[70%]">
            <button type="button" id="peringatan-biru-pertama" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="binaan-biru-pertama" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="teguran-biru-pertama" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="peringatan-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
            ...
            <button type="button" id="binaan-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
            ...
            <button type="button" id="teguran-biru-kedua" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="43" height="47" viewBox="0 0 43 47" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="peringatan-biru-ketiga" class="shadow-inset-custom flex justify-center items-center w-[50%] bg-grayDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="44" viewBox="0 0 47 44" fill="none">
            ...
            <button type="button" id="jatuhan-biru-minus" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DROP -</p>
            </button>
            <button type="button"  id="jatuhan-biru-plus" class="shadow-inset-custom flex justify-center items-center w-[25%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DROP +</p>
            </button>
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" class="shadow-inset-custom flex justify-center items-center w-[100%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">DISK</p>
            </button>
        </div>
        <div class="flex justify-between w-[70%]">
            <button type="button" id="popup-biru" class="shadow-inset-custom flex justify-center items-center w-[100%] bg-blueDefault hover:bg-blueDark focus:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <p class="font-bold text-whiteDefault text-lg">Pop Up</p>
            </button>
        </div>
    </div>
