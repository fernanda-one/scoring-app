...
<div class="flex justify-between mt-[5%] ml-[1%] mr-[2%]">
    ...
    <div class="flex flex-col justify-start w-[50%]">
        <div class="flex justify-between w-[70%]">
            <button type="button" id="teguran-merah-pertama" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="binaan-merah-pertama" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="peringatan-merah-pertama" class="flex justify-center items-center w-[50%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
                    <path d="M14.708 21.8679L10.7835 26.7735C10.2352 27.4588 9.95971 28.3023 10.0048 29.1579C10.0498 30.0136 10.4126 30.8275 11.0303 31.4588L18.4406 39.0376C19.1808 39.7958 20.2266 40.2273 21.3252 40.2273H30.3747C35.0747 40.2273 38.208 36.5554 38.208 32.8835L38.208 17.1477C38.208 12.9508 32.333 12.9508 32.333 17.1477L32.333 18.196" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M32.333 18.1562L32.333 15.0095C32.333 10.8125 26.458 10.8125 26.458 15.0095L26.458 18.1562L26.458 13.5664C26.458 9.36945 20.583 9.36945 20.583 13.5664L20.583 18.1562L20.583 6.22082C20.5825 5.49076 20.2728 4.79076 19.7219 4.2747C19.1711 3.75864 18.4242 3.46875 17.6455 3.46875C16.8664 3.46875 16.1193 3.75889 15.5684 4.27535C15.0175 4.79181 14.708 5.49227 14.708 6.22266L14.708 27.3359" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="teguran-merah-kedua" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="47" viewBox="0 0 45 47" fill="none">
            ...
            <button type="button" id="binaan-merah-kedua" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="peringatan-merah-kedua" class="flex justify-center items-center w-[50%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
        ...
        <div class="flex justify-between w-[70%]">
            <button type="button" id="jatuhan-merah" class="flex justify-center items-center w-[25%] bg-redDefault hover:bg-redDark focus:ring-2 focus:outline-none focus:ring-redDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
    ...
    <div class="flex flex-col justify-start items-end w-[50%]">
        <div class="flex justify-between w-[70%]">
            <button type="button" id="teguran-biru-pertama" class="flex justify-center items-center w-[50%] bg-blueDefault hover:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
            ...
            <button type="button" id="binaan-biru-pertama" class="flex justify-center items-center w-[25%] bg-blueDefault hover:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="47" height="45" viewBox="0 0 47 45" fill="none">
            ...
            <button type="button" id="pelanggaran-biru-pertama" class="flex justify-center items-center w-[25%] bg-blueDefault hover:bg-blueDark focus:ring-2 focus:outline-none focus:ring-blueDark rounded-[14px] text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 mb-2">
